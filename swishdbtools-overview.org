...
** 2013-11-06-make-ddixml-and-ddiindex-and-orapus
#+name:make-ddixml-and-ddiindex-and-orapus-header
#+begin_src markdown :tangle ~/projects/ivanhanigan.github.com.raw/_posts/2013-11-06-make-ddixml-and-ddiindex-and-orapus.md :exports none :eval no :padline no
---
...
- I argue that the reasons for less-than-adequate metadata can be understood by looking at 1) the culture of science training, 2) the tools available and 3) the funding organisations requirements to produce metadata 
- In my ongoing series of blog posts I am exploring the tools available.  
- In this post I just want to start the discussion about culture and funding requirements.

## Background 
### The ways that scientists (and librarians) write metadata are various:

Driving forces include:
- where the person was trained (the discipline and the institution/country), 
- what tools they have access to (and are comfortable using)
- 
