...
*** test-connect2oracle
#+name:connect2oracle
#+begin_src R :session *R* :tangle tests/test-connect2oracle.r :exports none :eval no
################################################################
# name:connect2oracle
...
#+begin_src R :session *R* :tangle tests/test-connect2postgres.r :exports none :eval no
################################################################
# name:connect2postgres
...
#+begin_src R :session *R* :tangle tests/test-ddiindexdb_remove_file.r :exports none :eval no
  ################################################################
  # name:ddiindexdb_remove_file
  require(swishdbtools)
...
#+name:ddiindexdb_remove_file
#+begin_src R :session *R* :tangle man/ddiindexdb_remove_file.Rd :exports none :eval no
################################################################
# name:ddiindexdb_remove_file
...
#+begin_src R :session *R* :tangle tests/test-ddiindexdb_sync_study.r :exports none :eval no
################################################################
# name:ddiindexdb_sync_study
...
*** test-get_pgpass
#+name:get_pgpass
#+begin_src R :session *R* :tangle tests/test-get_pgpass.r :exports none :eval no
  ################################################################
  # name:get_pgpass
  source("R/LinuxOperatingSystem.r")
  source("R/get_pgpass.r")
...
#+begin_src R :session *R* :tangle tests/test-LinuxOperatingSystem.r :exports none :eval no
################################################################
# name:LinuxOperatingSystem
...
#+begin_src R :session *R* :tangle tests/test-load2ddiindex_data.r :exports none :eval no
  ################################################################
  # name:load2ddiindex_data
...
#+name:load2ddiindex_data
#+begin_src R :session *R* :tangle man/load2ddiindex_data.Rd :exports none :eval no
################################################################
# name:load2ddiindex_data
...
#+begin_src R :session *R* :tangle tests/test-load2ddiindex_file.r :exports none :eval no
  ################################################################
  # name:load2ddiindex_file
    source("R/connect2oracle.r")
    source("R/add_filedscr.r")
...
#+name:load2ddiindex_file
#+begin_src R :session *R* :tangle man/load2ddiindex_file.Rd :exports none :eval no
################################################################
# name:load2ddiindex_file
...
#+begin_src R :session *R* :tangle tests/test-load2ddiindex_study.r :exports none :eval no
  ################################################################
  # name:test-load2ddiindex_study
  source("R/connect2oracle.r")
  source("R/add_stdydscr.r")
...
*** test-sql_summarise
#+name:sql_summarise
#+begin_src R :session *R* :tangle tests/test-sql_summarise.r :exports none :eval no
  ################################################################
  # name:sql_summarise
  require(plyr)
  summarise(baseball,
...
*** man-sql_summarise
#+name:sql_summarise
#+begin_src R :session *R* :tangle man/sql_summarise.Rd :exports none :eval no
################################################################
# name:sql_summarise
